 ...
 */
class ModelUserInformation(var website: String?="", var address: AddressInformation, var phone: String?="", var name: String?="", var company: CompanyInformation?, var id: String?="", var email: String?="", var username: String?="",var error:String="error") :
    Parcelable {
